...
public class TutActivity extends Activity implements OnClickListener{
	...
	RelativeLayout rlTutStage1,rlTutStage2,rlTutStage3,rlTutStage4;
	ImageView ivBtnNext ;
	int currentStage = 1 ;
	...
	private void init (){
		...
		rlTutStage4 = (RelativeLayout) findViewById(R.id.rlTutStage4);
		...
		rlTutStage4.setVisibility(View.GONE);
	...
	private void showNext(){
		...
		case 2:
			...
			break;
		case 3:
			appliyPredefinedAmin(rlTutStage3, R.anim.slide_out_to_right);
			appliyPredefinedAmin(rlTutStage4, R.anim.slide_in_from_left);
			rlTutStage4.setVisibility(View.VISIBLE);
			break;
		default:
			finish();
			break;
