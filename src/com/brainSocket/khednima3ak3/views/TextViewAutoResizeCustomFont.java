...
public class TextViewAutoResizeCustomFont extends TextView {
	...
	public TextViewAutoResizeCustomFont(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
	}

	public TextViewAutoResizeCustomFont(Context context, AttributeSet attrs, int defStyle) {
	...
	private void adjustTextSize(final String text) {
		  ...
		  TextViewAutoResizeCustomFont.super.setMaxLines(Math.min(maxTextSplits, mMaxLines));
